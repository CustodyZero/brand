#!/usr/bin/env python3
"""
Generate Steward social card at 1200×630px — parallel to Valet, identical
design, only the wordmark text and URL differ.

Output: brand/steward/social/steward-social-card.{svg,png}

Design follows the same brand values as Valet (locked April 2026):
  - Dark background (#0A0A0A) · Bronze accent (#9D7E49)
  - Bebas Neue wordmark, DM Mono secondary text
  - The Binding icon as structural accent
"""
...
OUT_DIR = BASE / "brand" / "steward" / "social"
...
URL_TEXT = "steward.custodyzero.com"
...
def main() -> None:
    ...
    svg_path = OUT_DIR / "steward-social-card.svg"
    ...
    out_png = OUT_DIR / "steward-social-card.png"
